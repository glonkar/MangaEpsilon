...
namespace MangaEpsilon.ViewModel
{
    ...
    public class MangaDetailPageViewModel : BaseViewModel
    {
        ...
        private async void SetManga(KeyValuePair<string, string>[] argument)
        {
            IsBusy = true;

            MangaEpsilon.Manga.Base.Manga selectedManga = await App.MangaSource.GetMangaInfo(argument[0].Value);
        ...
        private void InitializeCommands()
        {
            ...
            OpenMangaChapterCommand = CommandManager.CreateCommand(x =>
            {
                ...
                NavigationService.NavigateTo<MangaChapterViewPageViewModel>(new KeyValuePair<string, string>("manga", selectedChapter.ParentManga.MangaName), 
                    new KeyValuePair<string, string>("chapter", selectedChapter.Name));
            });
            ...
            BeginningChapterPageCommand = CommandManager.CreateCommand((o) =>
            {
                MangaChapters.CurrentPage = 0;
            });
            EndingChapterPageCommand = CommandManager.CreateCommand((o) =>
            {
                MangaChapters.CurrentPage = MangaChapters.MaxPageIndex;
            });
            NextChapterPageCommand = CommandManager.CreateCommand((o) =>
            {
                MangaChapters.CurrentPage++;
            });
            PreviousChapterPageCommand = CommandManager.CreateCommand((o) =>
            {
                MangaChapters.CurrentPage--;
            });
        ...
        {
            get { return GetPropertyOrDefaultType<CrystalCommand>(x => this.MangaClickCommand); }
            set { SetProperty(x => this.MangaClickCommand, value); }
        }

        public CrystalCommand BeginningChapterPageCommand { get { return GetPropertyOrDefaultType<CrystalCommand>(x => this.BeginningChapterPageCommand); } set { SetProperty<CrystalCommand>(x => this.BeginningChapterPageCommand, value); } }
        public CrystalCommand EndingChapterPageCommand { get { return GetPropertyOrDefaultType<CrystalCommand>(x => this.EndingChapterPageCommand); } set { SetProperty<CrystalCommand>(x => this.EndingChapterPageCommand, value); } }
        public CrystalCommand PreviousChapterPageCommand { get { return GetPropertyOrDefaultType<CrystalCommand>(x => this.PreviousChapterPageCommand); } set { SetProperty<CrystalCommand>(x => this.PreviousChapterPageCommand, value); } }
        public CrystalCommand NextChapterPageCommand { get { return GetPropertyOrDefaultType<CrystalCommand>(x => this.NextChapterPageCommand); } set { SetProperty<CrystalCommand>(x => this.NextChapterPageCommand, value); } }
        public CrystalCommand OpenMangaChapterCommand { get; set; }
        public CrystalCommand MangaDownloadCommand
        {
            get { return (CrystalCommand)GetProperty(x => this.MangaDownloadCommand); }
            set { SetProperty(x => this.MangaDownloadCommand, value); }
        }
        ...
        public CrystalCommand MangaAddFavoriteCommand
        {
            get { return GetPropertyOrDefaultType<CrystalCommand>(x => this.MangaAddFavoriteCommand); }
            set { SetProperty<CrystalCommand>(x => this.MangaAddFavoriteCommand, value); }
        }
        public CrystalCommand MangaRemoveFavoriteCommand
        {
            get { return GetPropertyOrDefaultType<CrystalCommand>(x => this.MangaRemoveFavoriteCommand); }
            set { SetProperty<CrystalCommand>(x => this.MangaRemoveFavoriteCommand, value); }
        }
    }
#endif
}
